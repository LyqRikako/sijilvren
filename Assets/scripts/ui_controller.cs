...
public class ui_controller : MonoBehaviour
{
    ...
    public levelup_selection_button[] levelUpButtons;
    ...
    {
        coinText.text = "Coins:" + coin_controller.instance.currentCoins;
    }
    ...
    {
        playstatcontroller.instance.PurchaseMoveSpeed();
        SkipLevelUp();
    }
    public void PurchaseHealth()
    {
        playstatcontroller.instance.PurchaseHealth();
        SkipLevelUp();
    }
    public void PurchasePickupRange()
    {
        playstatcontroller.instance.PurchasePickupRange();
        SkipLevelUp();
    }
    public void PurchaseMaxWeapons()
    {
        playstatcontroller.instance.PurchaseMaxWeapons();
        SkipLevelUp();
    }
